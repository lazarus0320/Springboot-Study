package com.example.jwtoauthtest.controller.auth;
...
public class AuthController {
    ...
    @Operation(summary = "유저 정보 확인", description = "현재 접속된 유저 정보를 확인합니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "유저 정보 삭제", description = "현재 접속된 유저 정보를 삭제합니다.")
    @ApiResponses(value = {
